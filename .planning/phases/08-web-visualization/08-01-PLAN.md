...
must_haves:
  truths:
    - "User opens http://localhost:37820 in a browser and sees the Memorite visualization shell"
...
- On page load: fetch initial graph and timeline data, store in a global state object `window.memoriteState = { graph: null, timeline: null }`
  </action>
  <verify>
