...
Purpose: This is the foundation for all semantic intelligence in Laminark. The pluggable interface (INT-01) ensures the system can swap embedding strategies without touching consumers. The KeywordOnlyEngine ensures graceful degradation (DQ-03) when ONNX is unavailable.
